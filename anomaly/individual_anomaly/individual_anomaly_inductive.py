...
from ..conformal import get_strangeness
from IntelliMaint.utils.Utils import DeviationContext, append_to_df
from IntelliMaint.utils.Utils import validate_individual_deviation_params, create_directory_from_path
...
class IndividualAnomalyInductive:
    ...
    def __init__(self, w_martingale=15, non_conformity="median", k=20, dev_threshold=0.6, columns=None):
        validate_individual_deviation_params(w_martingale, non_conformity, k, dev_threshold)
    ...
    def plot_deviations(self, figsize=None, savefig=None, plots=["data", "strangeness", "pvalue", "deviation", "threshold"], debug=False):
        ...
        if savefig is None:
            ...
            figpathname = create_directory_from_path(savefig)
